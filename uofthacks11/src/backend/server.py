...
# GPT4 was used as inspiration on how to generate the code to access kintone API
api_token = "o18U15exzzO8yNn8sEZtFSeJvcwX4HbDwiimg7cU"
...
def execute(file_urls):
    ...
    # call spotifyrec.py with top_three
